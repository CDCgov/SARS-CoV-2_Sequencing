...
- [SanitizeMe](https://github.com/CDCgov/SanitizeMe) - Scripts and an X11 GUI for removing human host sequences from metagenomic data before SRA submission.
